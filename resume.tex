...
B.Tech Computer Science and Engineering \textit{GPA: 8.67} \hfill Jul 2019 - May 2023\\
\vspace{2mm}
...
\textit{Software Engineer} \hfill May 2023 - Present\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item Built and deployed a distributed system for running a multi-model ensemble with rules for classification, rules for static forms and tables and slm for natural language information to perform extraction on multi page documents for document risk review system.  
...
{\textbf{microsoft/winget-pkgs}} {\sl YAML, Installtion Scripts} \hfill https://github.com/microsoft/winget-pkgs\\
