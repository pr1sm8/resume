...
\begin{itemize} \itemsep 1pt
    \item Built and deployed a distribution for running a multi-model ensemble with rules for classification, rules for static forms and tables and slm for natural language information to perform extraction on multi page documents for document risk review system.  
